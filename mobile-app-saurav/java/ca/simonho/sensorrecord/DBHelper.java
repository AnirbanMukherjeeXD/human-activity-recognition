...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATA_LIN_ACC_X = "linAccX";
    public static final String DATA_LIN_ACC_Y = "linAccY";
    public static final String DATA_LIN_ACC_Z = "linAccZ";
    ...
    public void insertDataTemp(short subNum, long time,
        ...
        sensorValues.put(DATA_LIN_ACC_X, linAcc[0]);
        sensorValues.put(DATA_LIN_ACC_Y, linAcc[1]);
        sensorValues.put(DATA_LIN_ACC_Z, linAcc[2]);
